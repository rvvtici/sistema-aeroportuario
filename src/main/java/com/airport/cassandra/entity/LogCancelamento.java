package com.airport.cassandra.entity;
...
@Table("log_cancelamento")
public class LogCancelamento {

    @PrimaryKeyColumn(name = "id", ordinal = 0, type = PrimaryKeyType.PARTITIONED)
    private String id; // formato: 1C-00000001
    ...
    // Tipo da entidade cancelada: VOO, PASSAGEM, PORTAO
    @Column("entidade_tipo")
    private String entidadeTipo;

    public LogCancelamento() {}

    public LogCancelamento(String id, LocalDate data, LocalTime horario,
