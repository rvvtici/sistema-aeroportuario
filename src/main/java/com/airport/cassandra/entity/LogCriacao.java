...
public class LogCriacao {
    ...
    private String id; // formato: 2B-00000001
    ...
    // Tipo da entidade criada: VOO, BAGAGEM, TICKET, PASSAGEM, PORTAO
    @Column("entidade_tipo")
    private String entidadeTipo;

    public LogCriacao() {}

    public LogCriacao(String id, LocalDate data, LocalTime horario,
